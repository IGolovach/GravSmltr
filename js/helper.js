    ...
    $(document).ready(function(){
        ...
        if(canvas && canvas.getContext){
            ...
            context.dot = function(position, radius){
                ...
                context.fillStyle = 'rgba(140,40,40,1.0)';
                context.beginPath();
...
var updateGForce = function(g_f){
    G=g_f;
};

var updateGPosition = function(g_x,g_y){
    center.x=g_x;
	center.y=g_y;
};

var updatePrevious = function(g_x,g_y){
    previous.position.x=g_x;
	previous.position.y=g_y;
};

var updateSteps = function(st){
    St=st;
};
